...
Public Class reporte_estudiosvb
    ...
    Private receiptForm As CrystalReportEstudios
    Private Sub frmRemisiones_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            'CrystalReportViewerestidios.ParameterFieldInfo = paramFiels

            populateReport()
            CrystalReportViewerestidios.Visible = True
    ...
    Private Sub ConfigureCrystalReports()
        receiptForm = New CrystalReportEstudios()
        Dim myConnectionInfo As ConnectionInfo = New ConnectionInfo()
        myConnectionInfo.DatabaseName = "LAPROVIDENCIA"
        myConnectionInfo.UserID = "sa"
        myConnectionInfo.Password = "$d4m4s0"

        CrystalReportViewerestidios.ReportSource = receiptForm
        SetDBLogonForReport(myConnectionInfo)

        CrystalReportViewerestidios.Visible = True
    End Sub
    Private Sub SetDBLogonForReport(ByVal myConnectionInfo As ConnectionInfo)
        Dim myTableLogOnInfos As TableLogOnInfos = CrystalReportViewerestidios.LogOnInfo
    ...
    Private Sub populateReport()
        ...
        queryStringCompanies = "select * from estudio where companyID= '" & currentCompany & "'"
        ...
        adapterCompanies.Fill(dsreceipt, "estudio")
