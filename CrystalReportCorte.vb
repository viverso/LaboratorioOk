...
Public Class CrystalReportCorte
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LABORATORIO.CrystalReportCorte.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportCorte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportCorte = New CrystalReportCorte
        rpt.Site = Me.Site
        Return rpt
    End Function
